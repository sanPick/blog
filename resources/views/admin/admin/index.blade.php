...
@section('content')
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><a href="adminAdd">添加管理员</a></h3>
    ...
    <table style="width:500px;  height:5px; text-align:center" class="active" cellspacing="0" cellpadding="0">
                                    <tr class="active" style="background:orange">
                                        ...
                                        <td class="active">管理员姓名</td>
                                        <td class="active">登录时间</td>
                                   ...
                                   <tr class="active" >
                                        <td class="active"><?= $v['adminId']?></td>
                                        <td class="active"><?= $v['adminName']?></td>
                                        <td class="active"><?= $v['adminTime']?></td>

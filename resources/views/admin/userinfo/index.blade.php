...
@section('content')
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
              <h3 class="page-header"><a href="userInfoAdd">添加用户详细信息</a></h3>
    ...
    <table style="width:500px;  height:5px; text-align:center" class="active" cellspacing="0" cellpadding="0">
                                    <tr class="active" style="background:orange">
                                        ...
                                        <td class="active">零钱</td>
                                        <td class="active">第三方登录方式</td>
                                   ...
                                   <tr class="active" >
                                        ...
                                        <td class="active"><?= $v['eamil']?></td>
                                        <td class="active"><?= $v['realName']?></td>
                                        <td class="active"><?= $v['idCard']?></td>
                                        <td class="active"><?= $v['sex']?></td>
                                        <td class="active"><?= $v['img']?></td>
                                        <td class="active"><?= $v['money']?></td>
                                        <td class="active"><?= $v['loginStatus']?></td>

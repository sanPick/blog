	  ...
	  <div class="text-box">
			<div class="text-content" id="text-content">
				...
				<ul class="clearfix join">
					<li>
						<div class="title">
							<img src="home/images/join_01.jpg" class="fl" style="float:left">
					...
					<li>
						<div class="title">
							<img src="home/images/join_02.jpg" class="fl" style="float:left">
					...
					<li>
						<div class="title">
							<img src="home/images/join_03.jpg" class="fl" style="float:left">
					...
					<li>
						<div class="title">
							<img src="home/images/join_04.jpg" class="fl" style="float:left">
					...
					<li>
						<div class="title">
							<img src="home/images/join_05.jpg" class="fl" style="float:left">
					...
					<li>
						<div class="title">
							<img src="home/images/join_06.jpg" class="fl" style="float:left">
					...
					<li>
						<div class="title">
							<img src="home/images/join_07.jpg" class="fl" style="float:left">

...
<div class="bg_color1 both">
	<div class="wl mtauto">
        <div class="crumbs">
        	<i class="iconfont location_icon"></i>您当前所在的位置：<a href="" class="fc_80">22世纪金融</a><em>&gt;</em>计算器</div>
    </div>
</div>
            ...
            <div class="pl25 pr25 bd_e6 ofh">
            	<div class="fl dib">
                	<div class="cal-in mt30">
                        <span>借款金额：</span>
                        <input id="amount" value="111" type="text">
                        <span>元</span>
                    </div>
                    <div class="cal-in mt22">
                        <span>预期年化：</span>
                        <input id="rate" value="1" type="text">
                        <span>%</span>
                    </div>
                    <div class="cal-in mt22">
                        <span>借款期限：</span>
                        <input id="period" value="1" type="text">
                        <span>月</span>
                    </div>
                    <div class="cal-in mt22 ofh">
                        <span class="fl dib">还款方式：</span>
                        <div class="fl dib ml22 mt15">
                        <label class="radio-box"><input class="radiobox" checked="checked" name="cal-type" value="t1" style="display:block;" type="radio"><i class=""></i>每月还息</label>
                        </div>
                        <div class="fl dib ml50 mt15">
                        <label class="radio-box"><input class="radiobox" name="cal-type" value="t2" type="radio"><i class=""></i>等额本息</label>
                        </div>
                    </div>
                ...
                <div class="fr dib cal-results">
                    ...
                    <div class="ofh bd_e6">
                        ...
                        <div class="ofh"><span class="dib fl fs20 fc_red fstyle2 mt40" id="ben_xi">111.09元</span><em class="cal-results-line2"></em><span class="dib fr fs20 fc_red fstyle2 mt40" id="li_xi">0.09元</span></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="invest-cal mt12 mb30">
            ...
            <div class="pl25 pr25 bd_e6 ofh">
            	<ul class="repay-plan">
                    ...
                    <div id="result"><li><span>第1期</span><span>2017-8-7</span><span>111.09元</span><span>111.00元</span><span>0.09元</span></li></div>
                </ul>
            </div>
        </div>
    </div>
